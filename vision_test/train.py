...
def train_model(model, dataloaders, criterion, optimizer, device, num_epochs=25, is_inception=False):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            print('{} Loss: {:.4f} Acc: {:.4f}'.format(phase, epoch_loss, 0))
...
data_dir = "/home/mcwave/data/image_net/ILSVRC2014_DET"

# cifar_data = torchvision.datasets.CIFAR10(data_dir)
...
# Train and evaluate
model_ft, hist = train_model(model_ft, dataloaders_dict, criterion, optimizer_ft, device=device, num_epochs=num_epochs, is_inception=(model_name=="inception"))